...
export async function setupTest() {
  const pkey = getRequiredEnv('E2E_TESTS_GOERLI_PKEY')
  const l1Rpc = getRequiredEnv('E2E_TESTS_GOERLI_L1_RPC')
  const l2Rpc = getRequiredEnv('E2E_TESTS_GOERLI_L2_RPC')
  ...
  const staticDeploymentString = getOptionalEnv('E2E_TESTS_GOERLI_DEPLOYMENT')
