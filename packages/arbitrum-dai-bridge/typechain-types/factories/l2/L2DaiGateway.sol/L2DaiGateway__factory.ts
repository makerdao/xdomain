...
import type {
  L2DaiGateway,
  L2DaiGatewayInterface,
} from "../../../l2/L2DaiGateway.sol/L2DaiGateway";
...
export class L2DaiGateway__factory extends ContractFactory {
  ...
  override deploy(
    ...
    _l2Router: PromiseOrValue<string>,
  ...
  override attach(address: string): L2DaiGateway {
    return super.attach(address) as L2DaiGateway;
  }
  override connect(signer: Signer): L2DaiGateway__factory {
