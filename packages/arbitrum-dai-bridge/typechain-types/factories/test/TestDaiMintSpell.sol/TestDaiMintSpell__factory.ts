...
} from "../../../test/TestDaiMintSpell.sol/TestDaiMintSpell";
...
export class TestDaiMintSpell__factory extends ContractFactory {
  ...
  override attach(address: string): TestDaiMintSpell {
    return super.attach(address) as TestDaiMintSpell;
  }
  override connect(signer: Signer): TestDaiMintSpell__factory {
