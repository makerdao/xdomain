...
} from "../../../test/TestBridgeUpgradeSpell.sol/TestBridgeUpgradeSpell";
...
export class TestBridgeUpgradeSpell__factory extends ContractFactory {
  ...
  override attach(address: string): TestBridgeUpgradeSpell {
    return super.attach(address) as TestBridgeUpgradeSpell;
  }
  override connect(signer: Signer): TestBridgeUpgradeSpell__factory {
