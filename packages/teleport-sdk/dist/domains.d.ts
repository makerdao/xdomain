...
export declare const DOMAINS: readonly ["RINKEBY-SLAVE-ARBITRUM-1", "RINKEBY-MASTER-1", "KOVAN-SLAVE-OPTIMISM-1", "KOVAN-MASTER-1", "OPT-GOER-A", "ARB-GOER-A", "ETH-GOER-A"];
export declare type DomainId = typeof DOMAINS[number];
export declare const DEFAULT_RPC_URLS: Dictionary<string, DomainId>;
export declare type DomainDescription = DomainId | 'arbitrum-testnet' | 'optimism-testnet' | 'optimism-goerli-testnet' | 'arbitrum-goerli-testnet';
